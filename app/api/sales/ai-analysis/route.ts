          ...
          content: [
            {
              ...
              text: [
                ...
                "externalFactors がある場合、regionalMovementReference は地域全体の参考情報であり、店舗への流入・流出予測として扱わないでください。",
                "hasEnoughComparison が false のイベントは『データ不足』とし、増減傾向を述べないでください。true の場合も、同曜日・同時間帯の売上対照として説明し、イベントが原因だと断定しないでください。",
                "外部イベントは impactWindow の時間帯単位で参照し、終日売上だけから影響を判断しないでください。",
